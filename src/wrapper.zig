    ...
    return struct {
        ...
        pub fn texImage1D(args: struct {
            ...
            bindings.TexImage1D(
                ...
                @bitCast(args.level),
                @bitCast(@intFromEnum(args.internal_format)),
                @bitCast(args.width),
        ...
        pub fn getString(name: StringParamName) ?[*:0]const u8 {
            return bindings.GetString(@bitCast(@intFromEnum(name)));
        }
        ...
        pub fn drawElements(
            ...
            switch(indices) {
                .slice => |s| bindings.DrawElements(@intFromEnum(mode), @intCast(s.len), @intFromEnum(index_type), @intFromPtr(s.ptr)),
                .count => |c| bindings.DrawElements(@intFromEnum(mode), @intCast(c), @intFromEnum(index_type), 0),
            }
        }
        ...
        pub fn deleteTexture(ptr: *const Texture) void {
            bindings.DeleteTextures(1, @as([*]Uint, @constCast(@ptrCast(ptr))));
        }
        pub fn deleteTextures(textures: []const Texture) void {
            bindings.DeleteTextures(@intCast(textures.len), @as([*]Uint, @constCast(@ptrCast(textures.ptr))));
        }

        pub fn genTexture(ptr: *Texture) void {
            bindings.GenTextures(1, @as([*]Uint, @ptrCast(ptr)));
        }
        pub fn genTextures(textures: []Texture) void {
            bindings.GenTextures(@intCast(textures.len), @as([*]Uint, @ptrCast(textures.ptr)));
        }
        ...
        pub fn deleteBuffer(ptr: *Buffer) void {
            bindings.DeleteBuffers(1, @as([*]Uint, @ptrCast(ptr)));
        }
        pub fn deleteBuffers(buffers: []Buffer) void {
            bindings.DeleteBuffers(@intCast(buffers.len), @as([*]Uint, @ptrCast(buffers.ptr)));
        }

        // pub var genBuffers: *const fn (n: Sizei, buffers: [*c]Uint) callconv(.c) void = undefined;
        pub fn genBuffer(ptr: *Buffer) void {
            bindings.GenBuffers(1, @as([*]Uint, @ptrCast(ptr)));
        }
        pub fn genBuffers(buffers: []Buffer) void {
            bindings.GenBuffers(@intCast(buffers.len), @as([*]Uint, @ptrCast(buffers.ptr)));
        }
        ...
        pub fn shaderSource(
            ...
            bindings.ShaderSource(
                ...
                @as([*]const [*]const Char, @ptrCast(src_ptrs)),
                if (maybe_src_lengths) |src_lengths| @as([*]Int, @constCast(@ptrCast(src_lengths.ptr))) else null,
            );
        }
        ...
        pub fn deleteRenderbuffer(ptr: *const Renderbuffer) void {
            bindings.DeleteRenderbuffers(1, @as([*]Uint, @constCast(@ptrCast(ptr))));
        }
        pub fn deleteRenderbuffers(renderbuffers: []const Renderbuffer) void {
            bindings.DeleteRenderbuffers(@intCast(renderbuffers.len), @as([*]Uint, @constCast(@ptrCast(renderbuffers.ptr))));
        }
        ...
        pub fn genRenderbuffer(ptr: *Renderbuffer) void {
            bindings.GenRenderbuffers(1, @as([*]Uint, @ptrCast(ptr)));
        }
        pub fn genRenderbuffers(renderbuffers: []Renderbuffer) void {
            bindings.GenRenderbuffers(@intCast(renderbuffers.len), @as([*]Uint, @ptrCast(renderbuffers.ptr)));
        }
        ...
        pub fn deleteFramebuffer(ptr: *const Framebuffer) void {
            bindings.DeleteFramebuffers(1, @as([*]Uint, @constCast(@ptrCast(ptr))));
        }
        pub fn deleteFramebuffers(framebuffers: []const Framebuffer) void {
            bindings.DeleteFramebuffers(@intCast(framebuffers.len), @as([*]Uint, @constCast(@ptrCast(framebuffers.ptr))));
        }
        ...
        pub fn genFramebuffer(ptr: *Framebuffer) void {
            bindings.GenFramebuffers(1, @as([*]Uint, @ptrCast(ptr)));
        }
        pub fn genFramebuffers(framebuffers: []Framebuffer) void {
            bindings.GenFramebuffers(@intCast(framebuffers.len), @as([*]Uint, @constCast(@ptrCast(framebuffers.ptr))));
        }
        ...
        pub fn deleteVertexArray(ptr: *const VertexArrayObject) void {
            bindings.DeleteVertexArrays(1, @constCast(@ptrCast(ptr)));
        }
        pub fn deleteVertexArrays(arrays: []const VertexArrayObject) void {
            bindings.DeleteVertexArrays(@intCast(arrays.len), @constCast(@ptrCast(arrays.ptr)));
        }
        ...
        pub fn genVertexArray(ptr: *VertexArrayObject) void {
            bindings.GenVertexArrays(1, @as([*]Uint, @ptrCast(ptr)));
        }
